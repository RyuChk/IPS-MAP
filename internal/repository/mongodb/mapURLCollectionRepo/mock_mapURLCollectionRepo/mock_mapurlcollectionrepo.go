...
// Source: map_url_collection_repo.go

// Package mock_mapurlcollectionrepo is a generated GoMock package.
package mock_mapurlcollectionrepo
...
func (m *MockRepository) FindOne(ctx context.Context, filter mongodb.Filter) (models.MapImageURL, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) InsertOne(ctx context.Context, document models.MapImageURL) error {
	m.ctrl.T.Helper()
