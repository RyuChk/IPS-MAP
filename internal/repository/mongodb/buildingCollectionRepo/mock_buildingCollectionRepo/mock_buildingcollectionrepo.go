...
// Source: building_collection_repo.go

// Package mock_buildingcollectionrepo is a generated GoMock package.
package mock_buildingcollectionrepo
...
func (m *MockRepository) Find(ctx context.Context, filter mongodb.Filter) ([]models.Building, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindOne(ctx context.Context, filter mongodb.Filter) (models.Building, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) InsertOne(ctx context.Context, document models.Building) error {
	m.ctrl.T.Helper()
