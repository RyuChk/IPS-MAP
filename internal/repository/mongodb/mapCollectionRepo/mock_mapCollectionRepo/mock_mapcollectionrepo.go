...
// Source: map_collection_repo.go

// Package mock_mapcollectionrepo is a generated GoMock package.
package mock_mapcollectionrepo
...
func (m *MockRepository) Find(ctx context.Context, filter mongodb.Filter) ([]models.Map, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindOne(ctx context.Context, filter mongodb.Filter) (models.Map, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) InsertOne(ctx context.Context, document models.Map) error {
	m.ctrl.T.Helper()
