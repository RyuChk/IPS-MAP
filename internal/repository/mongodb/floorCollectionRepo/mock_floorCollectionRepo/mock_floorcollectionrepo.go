...
// Source: floor_collection_repo.go

// Package mock_floorcollectionrepo is a generated GoMock package.
package mock_floorcollectionrepo
...
func (m *MockRepository) Find(ctx context.Context, filter mongodb.Filter) ([]models.Floor, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindOne(ctx context.Context, filter mongodb.Filter) (models.Floor, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) InsertOne(ctx context.Context, document models.Floor) error {
	m.ctrl.T.Helper()
